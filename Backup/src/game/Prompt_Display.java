...
///////*****************************************************
    ...
    protected void scenarioPrompt(){
        List<String> text = worldCtr == 1 ? scenarioTexts_1 : worldCtr == 2 ? scenarioTexts_2 :scenarioTexts_3;

        nextPrompt();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.println("|| " + text.get(encounterCtr-1));
        System.out.println("||");
        System.out.println("|| > Press ENTER to continue...");
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////// rest prompt
    protected void restPrompt(){
        nextPrompt();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.println("|| Congrats on making this far.");
        System.out.println("|| The next enemy will be the boss!");
        System.out.println("|| ");
        System.out.println("|| Will you heal up?");
        System.out.println("|| or ");
        System.out.println("|| Will you replenish uses?");
        System.out.println("|| ");
        System.out.println("|| > 1 : Heal HP                -> Replenish 30% of max HP");
        System.out.println("|| > 2 : Replenish skill USES   -> Replenish all of your skill uses by 5");
    }

//////////////////////////////////////////////////////////////////////////////////////////////////////////////// endworld prompt
    protected void endWorldPrompt(){
        nextPrompt();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.println("|| " + bossTexts.get(worldCtr-1));
        System.out.println("|| ");
        System.out.println("|| > Press ENTER to continue...");
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////// end gaame prompt
    ...
    protected void endGamePrompt(){
        nextPrompt();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.println("|| Game is finished for real.");
        System.out.println("|| Many things can be done for this project.");
        System.out.println("|| And all of it will be done if given time.");
