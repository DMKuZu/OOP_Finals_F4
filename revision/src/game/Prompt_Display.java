...
///////*****************************************************
    ...
    protected void scenarioPrompt(){
        List<String> text = worldCtr == 1 ? scenarioTexts_1 : worldCtr == 2 ? scenarioTexts_2 : worldCtr == 3 ? scenarioTexts_3 : scenarioTexts_4;
...
///////*****************************************************
    ...
    protected void encounter_battle_choice(Hero hero, Enemy enemy){
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.printf ("|| %s\n",enemy.getNAME());
...
//battle prompt
///////*****************************************************
    protected void battle_skills(Hero hero, Enemy enemy){
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.printf ("|| %s\n",enemy.getNAME());
    ...
    protected void battle_hero_action(Hero hero, Enemy enemy, String msg){
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.printf ("|| %s\n",enemy.getNAME());
    ...
    protected void battle_enemy_action(Hero hero, Enemy enemy, String msg){
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.printf ("|| %s\n",enemy.getNAME());
    ...
    protected void battle_favors(Hero hero, Enemy enemy) {
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
        System.out.printf ("|| %s\n",enemy.getNAME());
    ...
    protected void battle_info(Hero hero){
        nextPrompt();
        header();
        System.out.println("||--------------------------------------------------------------------------||");
